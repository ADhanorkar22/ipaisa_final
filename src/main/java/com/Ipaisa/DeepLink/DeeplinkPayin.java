...
@Entity
@Table(name = "deeplinkPayin")
public class DeeplinkPayin {
	...
	@Column(name = "key_id")
	private String keyId; // Changed from 'key' to 'keyId' to avoid reserved keyword issue
...
//	private User user;
	...
	public DeeplinkPayin() {
	}

	public DeeplinkPayin(Long id, String txnid, String firstname, String email, String phone, String key, String mode,
			...
			String bankName, String authCode) {
		super();
		this.id = id;
		this.txnid = txnid;
