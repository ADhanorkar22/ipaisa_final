...
public class GetIfscService {
	public static final Logger Logger=LoggerFactory.getLogger(GetRemitterrransferLimitService.class);
	 ...
	 @Value("${rupeebiz.api.token}")
	    ...
	    private final String URL ="https://api.rupeebiz.com/ws/dmr5/getifsc";

	    public String sendGetIfscRequest(GetIfscRequest getifsc) throws IOException {
	        ...
	        jsonPayload.put("bank_code",getifsc.getBank_code());
	        	        
	        
	        RequestBody formBody = new FormBody.Builder()
	                .add("apiToken", apiToken)  // Use the token from properties
	                .add("format", "")
	                .add("bank_code", getifsc.getBank_code())
	                .add("outletid", "5586")
	                 .build();
