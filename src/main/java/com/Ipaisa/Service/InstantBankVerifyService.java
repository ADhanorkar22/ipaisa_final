...
@Service
@Transactional
public class InstantBankVerifyService  implements LatitudeLongitude{
	private  static final String pennydrop="YES";
	 ...
	 @Value("${instantpay.client_id}")
		...
		private String Encryption_Key;
		 ...
		 public String encryptAndSendData(BankVerifyRequest payload) throws Exception {
			 
//			 URL url = new URL("http://ifconfig.me/ip");
//		    	HttpURLConnection con = (HttpURLConnection) url.openConnection();
//		    	con.setRequestMethod("GET");
//		    	BufferedReader in = new BufferedReader(new InputStreamReader(con.getInputStream()));
//		    endpointIp = in.readLine();
//		    	in.close();
...
//			 System.out.println("endpointIp============>"+endpointIp);
			...
			//System.out.println("encrypted aadhaar====>"+instatpayeny.encryptAadhaarNumber(payload.getAadhaarNumber(), Encryption_Key));
		        ...
		        body.put("accountNumber",payload.getAccountNumber());
		        body.put("bankIfsc", payload.getBankIfsc());
		        main.put("payee", body);
		        
		       
		        main.put("externalRef", generateTransactionId());
		        main.put("consent", Consent.valueOf("Y"));
		        main.put("pennyDrop", pennydrop);
		        main.put("latitude", LatitudeLongitude.Latitde);
		        main.put("longitude", LatitudeLongitude.Longitude);
...
//		        finalbody.put("data", body);
		        ...
		        System.out.println();
		        System.out.println();
		        System.out.println("final body======>"+main.toString());
		        System.out.println();
		        System.out.println();
		        System.out.println();
		        System.out.println();
		        System.out.println();
		        System.out.println();
		        String data = objectMapper.writeValueAsString(main);
