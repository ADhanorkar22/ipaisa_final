...
//			    private String apiUrl;
			    ...
			    private final String URL = "https://api.rupeebiz.com/ws/ipaydmr/transfer_status";
			    
			    
			    public String sendTransferStatusRequest(TransferStatusRequest tsr) throws IOException {
			        // Static data to be sent in the request
			        JSONObject jsonPayload = new JSONObject();
			        jsonPayload.put("apiToken", apiToken);
			        jsonPayload.put("format", tsr.getFormat());  
			        jsonPayload.put("reqid", tsr.getReqid());
			        jsonPayload.put("txndate",tsr.getTxndate());
